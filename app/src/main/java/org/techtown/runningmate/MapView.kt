...
class MapView(
...
) : Fragment(), OnMapReadyCallback, CoroutineScope { // 지도를 보여주는 뷰
    ...
    private lateinit var mapThread: Job // 코루틴 객체
    ...
    override val coroutineContext: CoroutineContext
        get() = mapThread + Dispatchers.Main
    ...
    override fun onMapReady(mNaverMap: NaverMap) {
        ...
        naverMap.addOnLocationChangeListener { // 좌표의 변화가 생겼을 때 발생하는 리스너
            Log.d("mapCycle", "${startRunning.mService.getMin()} : ${startRunning.mService.getSec()}")
    ...
    override fun onStart() {
        Log.d("mapCycle", "onStart")
        super.onStart()
        mapView.onStart()
    }

    override fun onResume() {
        Log.d("mapCycle", "onResume")
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        Log.d("mapCycle", "onSaveInstanceState")
